...
`;function n({children:e,className:r="",backdropClose:o,backdropClassName:t=""}){let{setShowModal:s}=v(p),a=W(null);return o&&l(a,()=>{s(!1)}),i.createElement(h,{className:t},i.createElement(g,{className:r,ref:a},e))}var z=({children:e,className:r="",backdropClose:o=!0,backdropClassName:t=""})=>{let[s,a]=b(!1);return{modal:s&&m.createElement(d,{showModal:s,setShowModal:a,options:{children:e,className:r,backdropClose:o,backdropClassName:t}},m.createElement(n,{className:r,backdropClose:o,backdropClassName:t},e)),openModal:()=>a(!0),closeModal:()=>a(!1)}};export{z as useModalWrapper};
